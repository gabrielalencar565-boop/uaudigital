-- 1) Ajusta policy de UPDATE para evitar USING(true) (mantém: qualquer autenticado pode atualizar)
...
-- 2) Relaxa autorização das rotinas de recomputar pontuação quando QUALQUER usuário marcar/desmarcar tarefas
--    (continua exigindo que esteja logado)
