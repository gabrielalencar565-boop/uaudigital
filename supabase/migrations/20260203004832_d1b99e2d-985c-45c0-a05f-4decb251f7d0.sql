-- Atualiza recompute_metas_prazos para ignorar tarefas na lixeira
...
BEGIN
  ...
  WHERE t.status = 'concluido'
    AND t.deleted_at IS NULL  -- Ignora tarefas na lixeira
...
-- Atualiza recompute_all_scores para ignorar tarefas na lixeira
