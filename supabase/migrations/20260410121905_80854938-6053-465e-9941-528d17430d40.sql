...
BEGIN
  ...
  LOOP
    ...
    IF v_is_tag_only_stage THEN
      ...
      -- Only default to 1.5 if NULL, respect explicit 0
    ...
    IF v_stage_uses_qty THEN
      ...
      -- Apply extra demand multiplier (0 means no bonus, multiply by 1)
    ...
    ELSE
      ...
      -- Apply extra demand multiplier (0 means no bonus)
