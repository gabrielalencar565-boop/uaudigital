ALTER TABLE public.pm_tasks ADD COLUMN IF NOT EXISTS is_extra_demand boolean NOT NULL DEFAULT false;

-- Update pm_sync_stage_completion to check is_extra_demand
...
BEGIN
  ...
  -- ═══ PERFORMANCE SYNC (always, even for extra demand) ═══
