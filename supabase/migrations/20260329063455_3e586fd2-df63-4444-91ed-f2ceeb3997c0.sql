...
-- Revert cutoff back to March (month < 3) so March+ uses new scoring
-- This means the new scoring system applies from March 2026 onwards
...
-- Update pm_sync_stage_completion cutoff back to March
...
BEGIN
  ...
  v_use_tags := (v_year > 2026 OR (v_year = 2026 AND v_month >= 3));
