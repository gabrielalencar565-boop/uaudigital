...
BEGIN
  ...
  -- PDF and Agendamento ALWAYS score parent assignee, regardless of subtask assignees
  ...
  ELSE
    ...
    -- For PDF/Agendamento: clean up any per-subtask-assignee tasks that don't match parent assignees
    ...
    -- For PDF/Agendamento with subtasks, qty = number of subtasks per parent assignee (split equally)
    DECLARE
      v_qty_per_user int;
    BEGIN
