                    ...
                    <PopoverTrigger asChild onClick={(e) => e.stopPropagation()}>
                      ...
                      >
                        {(sub.tags ?? []).length > 0 ? (
                          ...
                          <span className="h-4 w-4 rounded border border-dashed border-muted-foreground/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition">
