...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[10px] text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-button-sheen text-primary-foreground shadow-sm hover:brightness-110 active:brightness-95",
        hero:
          "bg-button-sheen text-primary-foreground shadow-glow hover:brightness-110 active:brightness-95",
        brand:
          "bg-brand text-white shadow-glow hover:brightness-110 active:brightness-95",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline: "border border-border/60 bg-transparent hover:bg-accent/50 hover:text-accent-foreground",
